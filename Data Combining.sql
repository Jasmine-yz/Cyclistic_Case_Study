CREATE TABLE `project-1-429715.cyclistic_tripdata.biketrips` AS (
  ...
  UNION ALL
  SELECT * FROM `project-1-429715.cyclistic_tripdata.2024_01_biketrips`
  UNION ALL
  SELECT * FROM `project-1-429715.cyclistic_tripdata.2024_01_biketrips`
  UNION ALL
  SELECT * FROM `project-1-429715.cyclistic_tripdata.2024_02_biketrips`
  UNION ALL
  SELECT * FROM `project-1-429715.cyclistic_tripdata.2024_03_biketrips`
  UNION ALL
  SELECT * FROM `project-1-429715.cyclistic_tripdata.2024_04_biketrips`
